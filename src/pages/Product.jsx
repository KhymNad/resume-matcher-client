            ...
            <main className={styles.main}>
                ...
                >
                    ...
                    <ol className={styles.steps}>
                        <li>
                            <strong>Upload Resume (PDF)</strong> – The user uploads a PDF resume, which is processed by a Python script using PDFPlumber.
                        </li>
                        <li>
                ...
                >
                    ...
                    <ul className={styles.features}>
                        ...
                        <li><strong>Python Resume Parser:</strong> A high-accuracy PDF text extraction and filtering script using PDFPlumber, integrated directly into the .NET Web API backend.</li>
                        <li><strong>Live Job Listings:</strong> Fetches jobs from Adzuna API based on matched skills and user-selected location.</li>
                        <li><strong>Multi-Service Architecture:</strong> Combines .NET 6 Web API, Python resume parser, and third-party APIs.</li>
